/*************************************************************************
 *  ./release/brandenburg-0.1/src/unitTests/fmdMcmc.cpp
...
int main(int argc, char* argv[])
{
  ...
  myMcmc->newAdaptiveMultiLogMRW("txInfec",txInfec);
  ...
  myMcmc->newAdaptiveMultiLogMRW("txSuscep",txSuscep);

  ParameterView txDelta;
  txDelta.push_back(&txparams[2]);
  txDelta.push_back(&txparams[3]);
  myMcmc->newAdaptiveMultiLogMRW("txDistance",txDelta);
